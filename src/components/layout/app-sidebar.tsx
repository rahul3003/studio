...
import { LogOut, Settings, LayoutDashboard, Users, Briefcase, Shield, Rocket, UserCircle2 } from "lucide-react";
import type { User } from "@/hooks/use-mock-auth"; // Assuming User type is exported
import { usePathname } from "next/navigation";
import { useMockAuth } from "@/hooks/use-mock-auth";

interface AppSidebarProps {
  user: User; // Use the User type from your auth hook
}
